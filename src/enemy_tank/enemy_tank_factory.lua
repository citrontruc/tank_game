...
function EnemyTankFactory:create_tank(initial_x, initial_y, size_x, size_y, speed, speed_run, distance_threshold)
    local enemy_tank = EnemyTank:new(initial_x, initial_y, size_x, size_y, speed, speed_run, distance_threshold)
    local zombie_graphics_handler = GraphicsHandler:new()
    ...
    enemy_tank:set_graphic_handler(zombie_graphics_handler)
